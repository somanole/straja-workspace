// Canonical tool catalog for Straja Vault UI/profile sync.
// This stays local to the Vault repo so Vault remains build-independent from Straja Agent.
...
export const USER_FACING_TOOL_GROUPS: Record<string, string[]> = {
  ...
  "Messaging": ["message"],
  "Agents & Nodes": ["agents_list", "image"],
  "Developer": [
    "vault_repo_exec",
    "vault_repos_list",
    "vault_process",
