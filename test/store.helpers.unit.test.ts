...
describe("handelize", () => {
  ...
  test("normalizes virtual paths", () => {
    expect(normalizeVirtualPath("vault://docs/readme.md")).toBe("vault://docs/readme.md");
    expect(normalizeVirtualPath("docs/readme.md")).toBe("docs/readme.md");
  });

  test("detects virtual paths", () => {
    expect(isVirtualPath("vault://docs/readme.md")).toBe(true);
    expect(isVirtualPath("/tmp/file.md")).toBe(false);
  });

  test("parses virtual paths", () => {
    expect(parseVirtualPath("vault://docs/readme.md")).toEqual({
      collectionName: "docs",
      path: "readme.md",
    });
  });
